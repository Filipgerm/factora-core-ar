...
async def _insert_gl(session: AsyncSession, org_id: str) -> None:
    ...
    demo_coa: list[
        ...
        (
            _demo_gl_account_id(4),
            "1211",
            "Accounts receivable — invoiced (detail)",
            GlAccountType.ASSET,
            GlNormalBalance.DEBIT,
            False,
            GlSubledgerKind.NONE,
        ...
        (
            _demo_gl_account_id(32),
            "5300",
            "Customer support staff (COGS)",
            GlAccountType.EXPENSE,
            GlNormalBalance.DEBIT,
            False,
            GlSubledgerKind.NONE,
