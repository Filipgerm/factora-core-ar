...
import type { AlertNotification } from "@/lib/types/fi-dashboard";
import {
...
type FiAlertsNotificationsProps = {
...
export function FiAlertsNotifications({
  items,
  badgeCount,
  canExpand,
  expanded,
        ...
        {items.length === 0 ? (
          ...
          items.map((n) => {
            const impact = n.details
              ...
              : getRiskSeverity(n.alertType).toLowerCase();
