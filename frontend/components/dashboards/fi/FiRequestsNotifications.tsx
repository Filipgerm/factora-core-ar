...
import type { RequestNotification } from "@/lib/types/fi-dashboard";
import { timeAgo } from "@/lib/utils/fi-dashboard";

type FiRequestsNotificationsProps = {
...
export function FiRequestsNotifications({
  items,
  badgeCount,
  canExpand,
  expanded,
