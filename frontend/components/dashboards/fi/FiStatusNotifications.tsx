...
import type { StatusNotification } from "@/lib/types/fi-dashboard";
import { timeAgo } from "@/lib/utils/fi-dashboard";

type FiStatusNotificationsProps = {
...
export function FiStatusNotifications({
  items,
  badgeCount,
  canExpand,
  expanded,
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm text-slate-900">
                      <span className="font-semibold">{n.businessName}</span> {display}
                    </p>
